namespace HREngine.Bots
{
    ...
    public class Playfield
    {
        ...
        public Playfield()
        {
            ...
            {
                i++;
                this.startedWithDamagedMinions |= m.Hp < m.maxHp && m.Hp >= 1;
                ...
                else if (m.name == CardDB.cardName.weespellstopper)
                {
                ...
                else if (m.name == CardDB.cardName.faeriedragon || 
                ...
                else if (m.name == CardDB.cardName.pintsizedsummoner)
                {
                    this.winzigebeschwoererin++;
                    this.startedWithWinzigebeschwoererin++;
                }

                else if (m.name == CardDB.cardName.manawraith)
                {
                    this.managespenst++;
                    this.startedWithManagespenst++;
                }
                else if (m.name == CardDB.cardName.nerubarweblord)
                {
                    this.nerubarweblord++;
                    this.startedWithnerubarweblord++;
                }
                else if (m.name == CardDB.cardName.venturecomercenary)
                {
                    this.soeldnerDerVenture++;
                    this.startedWithsoeldnerDerVenture++;
                }
                else if (m.name == CardDB.cardName.summoningportal)
                {
                    this.beschwoerungsportal++;
                    this.startedWithbeschwoerungsportal++;
                }

                else if (m.name == CardDB.cardName.raidleader) this.anzOwnRaidleader++;
                else if (m.name == CardDB.cardName.malganis) this.anzOwnMalGanis++;
                else if (m.name == CardDB.cardName.stormwindchampion) this.anzOwnStormwindChamps++;
                else if (m.name == CardDB.cardName.tundrarhino) this.anzOwnTundrarhino++;
                else if (m.name == CardDB.cardName.timberwolf) this.anzOwnTimberWolfs++;
                else if (m.name == CardDB.cardName.murlocwarleader) this.anzMurlocWarleader++;
                else if (m.name == CardDB.cardName.grimscaleoracle) this.anzGrimscaleOracle++;
                else if (m.name == CardDB.cardName.auchenaisoulpriest) this.anzOwnAuchenaiSoulpriest++;
                else if (m.name == CardDB.cardName.sorcerersapprentice)
                {
                    this.anzOwnsorcerersapprentice++;
                    this.anzOwnsorcerersapprenticeStarted++;
                }
                else if (m.name == CardDB.cardName.southseacaptain) this.anzOwnSouthseacaptain++;
                else if (m.name == CardDB.cardName.mechwarper)
                {
                    this.anzOwnMechwarper++;
                    this.anzOwnMechwarperStarted++;
                }
                else if (m.name == CardDB.cardName.steamwheedlesniper && this.ownHeroName == HeroEnum.hunter)
                {
				...
				else if (m.handcard.card.name == CardDB.cardName.kelthuzad)
				{
            ...
            foreach (Minion m in this.enemyMinions)
            {
                ...
                else if (m.name == CardDB.cardName.prophetvelen) this.enemydoublepriest++;
                else if (m.name == CardDB.cardName.manawraith)
                {
                    this.managespenst++;
                    this.startedWithManagespenst++;
                ...
                else if (m.name == CardDB.cardName.raidleader) this.anzEnemyRaidleader++;
                else if (m.name == CardDB.cardName.malganis) this.anzEnemyMalGanis++;
                else if (m.name == CardDB.cardName.stormwindchampion) this.anzEnemyStormwindChamps++;
                else if (m.name == CardDB.cardName.tundrarhino) this.anzEnemyTundrarhino++;
                else if (m.name == CardDB.cardName.timberwolf) this.anzEnemyTimberWolfs++;
                else if (m.name == CardDB.cardName.murlocwarleader) this.anzMurlocWarleader++;
                else if (m.name == CardDB.cardName.grimscaleoracle) this.anzGrimscaleOracle++;
                else if (m.name == CardDB.cardName.auchenaisoulpriest) this.anzEnemyAuchenaiSoulpriest++;
                else if (m.name == CardDB.cardName.sorcerersapprentice)
                {
                    this.anzEnemysorcerersapprentice++;
                    this.anzEnemysorcerersapprenticeStarted++;
                }
                else if (m.name == CardDB.cardName.southseacaptain) this.anzEnemySouthseacaptain++;
                else if (m.name == CardDB.cardName.mechwarper)
                {
                    this.anzEnemyMechwarper++;
                    this.anzEnemyMechwarperStarted++;
                }
                else if (m.name == CardDB.cardName.steamwheedlesniper && this.enemyHeroName == HeroEnum.hunter)
                {
        ...
        public bool isEqual(Playfield p, bool logg)
        {
            if (logg)
            {
				if (Math.Abs (this.value - p.value) > System.Double.Epsilon)
					return false;
            }
